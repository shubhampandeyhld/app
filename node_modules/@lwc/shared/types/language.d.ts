...
}, ArrayFindIndex: (predicate: (value: any, index: number, obj: any[]) => unknown, thisArg?: any) => number, ArrayIndexOf: (searchElement: any, fromIndex?: number | undefined) => number, ArrayJoin: (separator?: string | undefined) => string, ArrayMap: <U>(callbackfn: (value: any, index: number, array: any[]) => U, thisArg?: any) => U[], ArrayPop: () => any, ArrayPush: (...items: any[]) => number, ArrayReduce: {
