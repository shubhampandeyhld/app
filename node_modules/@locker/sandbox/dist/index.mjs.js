...
function createScriptDistortion$LWS({
  ...
  const {
    ...
    [distortionName$LWS](url$LWS) {
      ...
      if (url$LWS === '') {
        ReflectApply$1$LWS(ElementProtoSetAttributeNS$LWS, this, [attributeNamespaceURI$LWS, attributeName$LWS, url$LWS]);
        return;
      } // Normalize the URL.


      ReflectApply$1$LWS(HTMLAnchorElementProtoHrefSetter$LWS, normalizerAnchor$LWS, [url$LWS]);
      const resolvedURL$LWS = ReflectApply$1$LWS(HTMLAnchorElementProtoHrefGetter$LWS, normalizerAnchor$LWS, []); // Create a dataset attribute to expose the undistorted attribute value.
      ...
      ReflectApply$1$LWS(XhrProtoOpen$LWS, xhr$LWS, ['GET', resolvedURL$LWS]);
...
const policyOptions$LWS = {
  ...
  createHTML: (_content$LWS, _providedOptions$LWS) => new StringCtor$1$LWS(''),
  ...
  createScriptURL: (_url$LWS, providedOptions$LWS) => {
    ...
    if (options$LWS) {
      ...
      const cleanup$LWS = () => {
        ...
        ReflectDeleteProperty$1$LWS(targetElement$LWS, SCRIPT_EVALUATOR_PROPERTY_NAME$LWS);
        ReflectApply$1$LWS(HTMLScriptElementProtoSrcSetter$LWS, targetElement$LWS, [_url$LWS]);
      };

      const onerror$LWS = () => {
        ReflectApply$1$LWS(EventTargetProtoRemoveEventListener$LWS, targetElement$LWS, ['error', onerror$LWS]);
        cleanup$LWS();
      };

      ReflectApply$1$LWS(XhrProtoWithCredentialsSetter$LWS, _xhr$LWS, [true]);
      ReflectApply$1$LWS(EventTargetProtoAddEventListener$LWS, _xhr$LWS, ['load', () => {
        if (ReflectApply$1$LWS(XhrProtoStatusGetter$LWS, _xhr$LWS, []) === 200) {
          const _responseText$LWS = ReflectApply$1$LWS(XhrProtoResponseTextGetter$LWS, _xhr$LWS, []);
          ...
          ReflectDefineProperty$1$LWS(targetElement$LWS, SCRIPT_EVALUATOR_PROPERTY_NAME$LWS, evaluatorDesc$LWS);
          const safeUrl$LWS = URLCreateObjectURL$LWS(new BlobCtor$LWS([`document.currentScript.${SCRIPT_EVALUATOR_PROPERTY_NAME$LWS}()`], {
            __proto__: null,
            type: 'text/javascript'
          }));
          ReflectApply$1$LWS(HTMLScriptElementProtoSrcSetter$LWS, targetElement$LWS, [safeUrl$LWS]);
        } else {
          ReflectApply$1$LWS(EventTargetProtoAddEventListener$LWS, targetElement$LWS, ['error', onerror$LWS]);
          ReflectApply$1$LWS(HTMLScriptElementProtoSrcSetter$LWS, targetElement$LWS, ['blob:http://localhost/not-found']);
        }
      }]);
      const _resolvedURL$LWS = normalizeUrl$LWS(_url$LWS);
      ReflectApply$1$LWS(XhrProtoOpen$LWS, _xhr$LWS, ['GET', _resolvedURL$LWS]);
      ReflectApply$1$LWS(XhrProtoSend$LWS, _xhr$LWS, []); // We shadow the native HTMLScript.src property by defining a
      ...
      return new StringCtor$1$LWS(_url$LWS);
    }

    return new StringCtor$1$LWS('');
  },
  // Reject anything for createScript until further requirements.
  createScript: (_sourceText$LWS, _providedOptions$LWS) => new StringCtor$1$LWS('')
    ...
    distortionCallback(originalTarget$LWS) {
      ...
      if (ObjectHasOwn$1$LWS(originalTarget$LWS, 'window') && originalTarget$LWS.window === originalTarget$LWS) {
        ...
        try {
          ...
          defaultView$LWS = ReflectApply$1$LWS(DocumentProtoDefaultViewGetter$LWS, originalTarget$LWS, []); // eslint-disable-next-line no-empty
        } catch (_unused41$LWS) {}
