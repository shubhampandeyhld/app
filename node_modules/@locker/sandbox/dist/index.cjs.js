...
function createScriptDistortion$LWS({
  ...
  const {
    ...
    [distortionName$LWS](url$LWS) {
      ...
      if (url$LWS === '') {
        shared$LWS.ReflectApply(sharedDom$LWS.ElementProtoSetAttributeNS, this, [attributeNamespaceURI$LWS, attributeName$LWS, url$LWS]);
        return;
      } // Normalize the URL.


      shared$LWS.ReflectApply(sharedDom$LWS.HTMLAnchorElementProtoHrefSetter, sharedUrl$LWS.normalizerAnchor, [url$LWS]);
      const resolvedURL$LWS = shared$LWS.ReflectApply(sharedDom$LWS.HTMLAnchorElementProtoHrefGetter, sharedUrl$LWS.normalizerAnchor, []); // Create a dataset attribute to expose the undistorted attribute value.
      ...
      shared$LWS.ReflectApply(sharedDom$LWS.EventTargetProtoAddEventListener, xhr$LWS, ['load', () => {
        ...
        if (status$LWS === 200) {
          if (sharedDom$LWS.defineSrcEvaluatorProperty(this, sandboxEvaluator$LWS)) {
            ...
            shared$LWS.ReflectApply(sharedDom$LWS.ElementProtoSetAttributeNS, this, [attributeNamespaceURI$LWS, attributeName$LWS, sharedDom$LWS.getSrcEvaluatorHookSourceText(responseText$LWS)]);
          }
        } else {
      ...
      shared$LWS.ReflectApply(sharedDom$LWS.XhrProtoOpen, xhr$LWS, ['GET', resolvedURL$LWS]);
  ...
  return function distortionNodeTextContentSetter$LWS(record$LWS) {
    ...
    return [originalTextContentSetter$LWS, function textContent$LWS(value$LWS) {
      ...
      if (this instanceof HTMLScriptElement$LWS || this instanceof SVGScriptElement$LWS) {
        if (sharedDom$LWS.defineTextContentEvaluatorProperty(this, valueAsString$LWS, (sourceText$LWS, context$LWS, globalObject$LWS, document$LWS) => {
          ...
          shared$LWS.ReflectApply(originalTextContentSetter$LWS, this, [sharedDom$LWS.getTextContentEvaluatorHookSourceText()]);
          return;
        }
      } // istanbul ignore else: needs default platform behavior test
...
const policyOptions$LWS = {
  ...
  createHTML: (_content$LWS, _providedOptions$LWS) => new shared$LWS.StringCtor(''),
  ...
  createScriptURL: (_url$LWS, providedOptions$LWS) => {
    ...
    if (options$LWS) {
      ...
      const _xhr$LWS = new sharedDom$LWS.XhrCtor();

      const cleanup$LWS = () => {
        shared$LWS.ReflectDeleteProperty(targetElement$LWS, 'src');
        shared$LWS.ReflectDeleteProperty(targetElement$LWS, sharedDom$LWS.SCRIPT_EVALUATOR_PROPERTY_NAME);
        shared$LWS.ReflectApply(sharedDom$LWS.HTMLScriptElementProtoSrcSetter, targetElement$LWS, [_url$LWS]);
      };

      const onerror$LWS = () => {
        shared$LWS.ReflectApply(sharedDom$LWS.EventTargetProtoRemoveEventListener, targetElement$LWS, ['error', onerror$LWS]);
        cleanup$LWS();
      };

      shared$LWS.ReflectApply(sharedDom$LWS.XhrProtoWithCredentialsSetter, _xhr$LWS, [true]);
      shared$LWS.ReflectApply(sharedDom$LWS.EventTargetProtoAddEventListener, _xhr$LWS, ['load', () => {
        if (shared$LWS.ReflectApply(sharedDom$LWS.XhrProtoStatusGetter, _xhr$LWS, []) === 200) {
          const _responseText$LWS = shared$LWS.ReflectApply(sharedDom$LWS.XhrProtoResponseTextGetter, _xhr$LWS, []);
          ...
          shared$LWS.ReflectDefineProperty(targetElement$LWS, sharedDom$LWS.SCRIPT_EVALUATOR_PROPERTY_NAME, evaluatorDesc$LWS);
          const safeUrl$LWS = sharedDom$LWS.URLCreateObjectURL(new sharedDom$LWS.BlobCtor([`document.currentScript.${sharedDom$LWS.SCRIPT_EVALUATOR_PROPERTY_NAME}()`], {
            __proto__: null,
            type: 'text/javascript'
          }));
          shared$LWS.ReflectApply(sharedDom$LWS.HTMLScriptElementProtoSrcSetter, targetElement$LWS, [safeUrl$LWS]);
        } else {
          shared$LWS.ReflectApply(sharedDom$LWS.EventTargetProtoAddEventListener, targetElement$LWS, ['error', onerror$LWS]);
          shared$LWS.ReflectApply(sharedDom$LWS.HTMLScriptElementProtoSrcSetter, targetElement$LWS, ['blob:http://localhost/not-found']);
        }
      }]);
      const _resolvedURL$LWS = sharedUrl$LWS.normalizeUrl(_url$LWS);
      shared$LWS.ReflectApply(sharedDom$LWS.XhrProtoOpen, _xhr$LWS, ['GET', _resolvedURL$LWS]);
      shared$LWS.ReflectApply(sharedDom$LWS.XhrProtoSend, _xhr$LWS, []); // We shadow the native HTMLScript.src property by defining a
      ...
      return new shared$LWS.StringCtor(_url$LWS);
    }

    return new shared$LWS.StringCtor('');
  },
  // Reject anything for createScript until further requirements.
  createScript: (_sourceText$LWS, _providedOptions$LWS) => new shared$LWS.StringCtor('')
    ...
    distortionCallback(originalTarget$LWS) {
      ...
      if (shared$LWS.ObjectHasOwn(originalTarget$LWS, 'window') && originalTarget$LWS.window === originalTarget$LWS) {
        ...
        try {
          ...
          defaultView$LWS = shared$LWS.ReflectApply(sharedDom$LWS.DocumentProtoDefaultViewGetter, originalTarget$LWS, []); // eslint-disable-next-line no-empty
        } catch (_unused41$LWS) {}
