...
declare class Validator {
    ...
    constructor(globalObject: GlobalObject, document: Document);
}
export declare const rootValidator: Validator;
export declare function getValidator(globalObject?: GlobalObject, document?: Document | undefined): any;
export {};
