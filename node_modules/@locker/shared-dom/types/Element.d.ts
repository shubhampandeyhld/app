...
export declare const ElementProtoClosest: {
    ...
    <E extends Element = Element>(selectors: string): E | null;
}, ElementProtoRemoveAttributeNode: (attr: Attr) => Attr, ElementProtoRemoveAttributeNS: (namespace: string | null, localName: string) => void, ElementProtoSetAttribute: (qualifiedName: string, value: string) => void, ElementProtoSetAttributeNS: (namespace: string | null, qualifiedName: string, value: string) => void;
